  ...
  onLoad: function () {
    ...
    util.api.request({
      ...
      success: function (res) {
        ...
        var producttype = []
        var brand = []
        for (var i = 0; i < res.data.productTypeList.length; i++) {
          producttype.push(res.data.productTypeList[i].catename)
        }
        for (var i = 0; i < res.data.brandList.length; i++) {
          brand.push(res.data.brandList[i].brandname)
        }
        that.setData({
          screen_content1: res.data.productTypeList,
          screen_content2: res.data.brandList,
          producttype: producttype,
          brand: brand,
          unit: res.data.unitList,
